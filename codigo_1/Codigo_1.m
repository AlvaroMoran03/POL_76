...
b0 = [0 0.5 0.5];                        % mean of prior distribution for beta
P0 = [10 0 0; 0 10 0; 0 0 10];           % variance of prior distribution for beta
...
legend('Estimated', 'Posterior Median', 'Prior', 'Location', 'northwest')
xlabel('\rho', 'FontSize', 12)
ylabel('Frequency' ,'FontSize', 12)
h = findobj(gca, 'Type', 'patch');
set(h, 'FaceColor', '#0072BD', 'EdgeColor', '#0072BD')

if ~exist('graphs 1', 'dir')
    mkdir('graphs 1');
end

saveas(gcf, 'graphs 1/rho posterior.png')
